		...
		if(id >0){
			...
			function(data){
				if(data != null&& data.length > 0){
					...
					"class ='form-control' onchange='chType(this)' id='type0'><option value='"+id+"'>--请选择分类--</option>";
...
<div class="form-group col-md-12" id ="types">
	<label id="lablel1" class="col-sm-2 control-lable" for="name">分类：</label>
		<div class="col-sm-2">
...
<label id="label1" class="col-md-2 control-lable" for="name">属性名：</label>
...
<c:if test="${param.status.equals('2')}">
	<div class="alert alert-info" role="alert">删除属性选项成功</div>
</c:if>
</div>
</div>
