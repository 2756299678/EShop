	...
	<div class="container">
		...
		<form enctype="multipart/form-data" id="myForm" role="form" action="productServlet?method=add" method="post">
			...
			<div class="form-group col-md-12">
				...
				<div class=" col-md-4">
					<input class="form-control" name="originalPrice" type="text" value="${productBean.originalPrice}" />
				</div>
				<label class="col-md-2 control-label" for="name">商品现价： </label>
				<div class="col-md-4">
					<input class="form-control" name="price" type="text" value="${productBean.price}" />
				</div>
			</div>
			<div class="form-group col-md-12">
