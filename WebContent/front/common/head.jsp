...
<body>
	<div class="navbar navbar-defult" role="navigation" style="background-color:#A52A2A">
		...
		<!-- Brand and toggle get grouped for better mobile display -->
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		    	...
		    	<ul class="nav navbar-nav navbar-right">
		    		<li><a target="_parent" href="${pageContext.request.contextPath}/front/user/userServlet?method=end&status=1">退出登录</a></li>
		    	</ul>
		    	<ul class="nav navbar-nav navbar-right">
		    		<li><a target="_parent" href="#">订单中心</a></li>
		    	</ul>
		    	<ul class="nav navbar-nav navbar-right">
		    		<li><a target="_parent" href="${pageContext.request.contextPath}/front/user/userInfo.jsp">用户：${userBean.username}</a></li>
		    	</ul>
		    	<ul class="nav navbar-nav navbar-right">
