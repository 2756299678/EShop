...
public class TypeTag extends SimpleTagSupport {
	...
	private String getStr2(List<ProductTypeBean> typeBeans2) {
		...
		if(typeBeans2!=null)
		{
			...
			{
				sb.append("<em>");
				sb.append("<a href='").append(path).append("/front/productShow/productShowServlet?method=sort&id=").append(item.getId()).append("'>").append(item.getName());
				sb.append("</a></em>");
